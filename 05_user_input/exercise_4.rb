...
#Probably not the most succinct, but saw an opportunity to use recursion and wanted to try it.

=begin
This solution is really cool for my level of knowledge.  It has new syntax and a great way of using a loop.
Solution
